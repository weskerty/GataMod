...
global.owner = [
["595972184435", 'Marco', true], //𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿 💖🐈
["595984470201"], 
["595972232260"], 
["595991190555"]]
...
global.packname = `BasureroOFC` //"𝙂𝙖𝙩𝙖𝘽𝙤𝙩-𝙈𝘿 🐈"
global.author = `xurl.es/REGLAS` //"𝙂𝙖𝙩𝙖 𝘿𝙞𝙤𝙨"
...
global.botdate = `⫹⫺ Date :  ${moment.tz('America/Asuncion').format('DD/MM/YY')}`; //Asia/Jakarta
global.bottime = `𝗧 𝗜 𝗠 𝗘 : ${moment.tz('America/Asuncion').format('HH:mm:ss')}`;//America/Los_Angeles
global.fgif = {
key: {
